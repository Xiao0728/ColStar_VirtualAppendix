...
def train(args):
    ...
    colbert = ColBERT.from_pretrained('google/electra-large-discriminator',
                                      query_maxlen=args.query_maxlen,
                                      doc_maxlen=args.doc_maxlen,
                                      dim=args.dim,
                                      similarity_metric=args.similarity,
                                      mask_punctuation=args.mask_punctuation)
    colbert.electra.resize_token_embeddings(len(colbert.tokenizer))
...
#     resume_training=True
    if args.checkpoint:
        print_message("resume training now")
#     if args.resume:
