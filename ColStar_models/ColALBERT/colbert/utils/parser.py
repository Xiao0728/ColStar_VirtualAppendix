...
#         self.add_argument('--base_model', dest='base_model', default='xlm-roberta-large')
        # self.add_argument('--base_model', dest='base_model', default='roberta-base')
#         self.add_argument('--base_model', dest='base_model', default='albert-base-v2')
#         self.add_argument('--base_model', dest='base_model', default='albert-xxlarge-v2')
        self.add_argument('--base_model', dest='base_model', default='albert-base-v2')
